...
ActiveRecord::Schema.define(version: 20170607144309) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "salutation"
    t.hstore "privacy_settings", default: {"tumblr_name"=>"false", "pinterest_name"=>"false", "twitter_handle"=>"false", "facebook_username"=>"false", "linkedin_username"=>"false", "instagram_username"=>"false"}, null: false
